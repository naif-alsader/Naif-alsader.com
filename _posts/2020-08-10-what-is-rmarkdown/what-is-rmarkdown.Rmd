...
<div style = "background-color:#455a64; color:white; margin-right: 5em;
    border-radius: 10px;">
...
وغيرها الكثير تجدها في الكتابين المذكورات في الأعلى
...
```{r, fig.cap="source:https://bookdown.org/yihui/rmarkdown-cookbook"}
